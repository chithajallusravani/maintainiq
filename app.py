...
# ============================================================
# FALLBACK MODEL COMPARISON TABLES
# ============================================================
...
def home():
    ...
    with a:
        ...
        with st.container():
            ...
            st.success(
                "All six deployment artifacts are loaded."
            )
...
def about():
    ...
    with a:
        ...
        with st.container():
            ...
            st.write(
                ...
                "designed to predict machine risk "
                "before unexpected failures occur."
            )
    ...
    with st.container():
        ...
        st.caption(
            "Saved preprocessing performs numeric "
